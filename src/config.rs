...
pub const fonts: [&[u8]; 1] = [b"Fixed:size=11"];
...
pub const keys: [Key; 25] = [
    ...
    Key { modif:MODKEY,                 keysym:XK_Return as u64, func:spawn, arg:Arg {s: "kitty"}},
    Key { modif:MODKEY,                 keysym:XK_x as u64, func:spawn, arg:Arg {s: "rofi -modi drun,run -show run -location 1 -xoffset 0"}},
    Key { modif:MODKEY|xlib::ShiftMask, keysym:XK_e as u64, func:quit, arg:Arg {i: 0}},

    Key { modif:MODKEY,                 keysym:XK_q as u64,        func:closeClient, arg:Arg {i: 0}},
...
pub const startCmds: [&str; 1] = [
    "feh --bg-scale /home/anfid/Pictures/Wallpapers/LoneWolf.png",
    //"statusbar"
];
